# Arena Agent Handoff Prompt — PHANTOM + CODED (push-to-main)
...
>
> PHANTOM-AI-specific version of the generic handoff (`docs/arena-agent-prompt-template.md`).
> The full build-and-release spec lives in `docs/arena-agent-prompt-build-structure.md`.
